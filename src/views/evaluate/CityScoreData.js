const targetData = [
    ...
    },
    {
        ...
        scale: "城区",
        level: "单元",
        detail: "以灾中可正常营业的菜市场（生鲜超市）为起点，步行10min可达到范围的区域面积/地区总面积"
    }],
    [{
    ...
    },
    {
        ...
        scale: "区域/城区",
        level: "总体/单元",
        detail: "任意医疗急救中心救护车至地区交通最不利点（高峰时段）所需要时间"
    }],
    [{
