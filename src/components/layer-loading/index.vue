    ...
    >
      ...
      >
        ...
        <div class="all" v-for="(city, i) in youList">
          <el-form-item :label="i == 0 ? '优化核心设施选址' : ''">
            <el-checkbox-group
  ...
  methods: {
    ...
    handJian(value) {
      if (value) {
        ...
        if (this.ruleForm.checkedList1.indexOf("4") !== -1) {
        ...
        if (this.ruleForm.checkedList2.indexOf("5") !== -1) {
    ...
    handleCheckedCitiesChange(value) {
      ...
      if (value.includes("2")) {
        ...
        if (this.ruleForm.checkedList2.indexOf("1") !== -1) {
          this.ruleForm.checkedList2.splice(
            this.ruleForm.checkedList2.indexOf("1"),
            1
          );
        }
        if (this.ruleForm.checkedList2.indexOf("2") !== -1) {
          this.ruleForm.checkedList2.splice(
    ...
    async handUp() {
      ...
      let form = {
        ...
        cityName: this.cityList[index].cityName,
        natural: this.ruleForm.ziran,
        accident: this.ruleForm.shigu,
        sanitation: this.ruleForm.gong,
        list,
        rain: this.ruleForm.rainList && this.ruleForm.rainList.length > 0 ? this.ruleForm.rainList[0] : '',
        rainTime: this.ruleForm.rainList && this.ruleForm.rainList.length > 0 ? this.ruleForm.rainList[1] : '',
        contagion: this.ruleForm.contagion && this.ruleForm.contagion.length > 0 ? this.ruleForm.contagion[0] : ''
      };
